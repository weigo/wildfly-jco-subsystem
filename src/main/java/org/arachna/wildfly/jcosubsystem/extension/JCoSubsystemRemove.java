 ...
 */
class JCoSubsystemRemove extends AbstractRemoveStepHandler {

    static final JCoSubsystemRemove INSTANCE = new JCoSubsystemRemove();

    private static final Logger LOGGER = Logger.getLogger(JCoSubsystemRemove.class);

    private JCoSubsystemRemove() {
    }
